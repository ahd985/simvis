...
const staticLevelIcon = <svg viewBox={iconViewBox} width={iconWidth} height={iconHeight}>
        <g>
            ...
            <path d="m 50,50 0,20 m 8,-8 -8,8 -8,-8" style={{fill:"none",stroke:"#000000",strokeWidth:"2px"}} />
        </g>
    </svg>;
...
const zonalYIcon = <svg viewBox={iconViewBox} width={iconWidth} height={iconHeight}>
        <g >
            ...
            <path style={{fill:"none",stroke:"#000000",strokeWidth:"1px"}} d="m 0,67 100,0" />
        </g>
    </svg>;
...
const equalYIcon = <svg viewBox={iconViewBox} width={iconWidth} height={iconHeight}>
        <g style={{strokeWidth:"10"}}>
            ...
            <path style={{fill:"none",stroke:"#acacac",strokeWidth:"10"}} d="m 50,75 0,25" />
        </g>
    </svg>;
...
const colorScaleIcon = <svg viewBox={iconViewBox} width={iconWidth} height={iconHeight}>
        <g>
            ...
            <path d="m 75,25 25,0" style={{fill:"none",stroke:"#acacac",strokeWidth:"25"}} />
            <text style={{fill:"#000000",stroke:"none",strokeWidth:"1px"}} x="0" y="60" ><tspan x="0" y="60">1</tspan></text>
            <text style={{fill:"#000000",stroke:"none",strokeWidth:"1px"}} x="25" y="60" ><tspan x="25" y="60">2</tspan></text>
            <text style={{fill:"#000000",stroke:"none",strokeWidth:"1px"}} x="50" y="60" ><tspan x="50" y="60">3</tspan></text>
            <text style={{fill:"#000000",stroke:"none",strokeWidth:"1px"}} x="75" y="60" ><tspan x="75" y="60">4</tspan><circle r="50" cy="50" cx="50" /></text>
        </g>
    </svg>;

const logicalIcon = <svg viewBox={iconViewBox} width={iconWidth} height={iconHeight}>
        <g>
            <circle r="50" style={{fill:"#d1d1d1",stroke:"#000000",strokeWidth:"2"}} cx="50" cy="50" />
            <g><text><tspan>ON/OFF</tspan></text></g>
        </g>
    </svg>;

const showHideIcon = <svg viewBox={iconViewBox} width={iconWidth} height={iconHeight}>
        <g>
            <g>
                <circle r="50" style={{fill:"#d1d1d1",stroke:"#000000",strokeWidth:"2"}} cx="50" cy="50" />
            </g>
            <g>
                <g transform="translate(19,19)">
                    <path d="m 11.285,41.39 c 0.184,0.146 0.404,0.218 0.623,0.218 0.294,0 0.585,-0.129 0.783,-0.377 0.344,-0.432 0.273,-1.061 -0.159,-1.405 -0.801,-0.638 -1.577,-1.331 -2.305,-2.06 l -7.398,-7.398 7.629,-7.629 c 7.334,-7.333 18.003,-9.836 27.839,-6.534 0.523,0.173 1.09,-0.107 1.267,-0.63 0.175,-0.523 -0.106,-1.091 -0.63,-1.267 C 28.372,10.763 16.918,13.451 9.044,21.324 L 0,30.368 8.812,39.18 c 0.781,0.782 1.614,1.525 2.473,2.21 z" /> <path d="m 50.237,21.325 c -1.348,-1.348 -2.826,-2.564 -4.394,-3.616 -0.458,-0.307 -1.081,-0.185 -1.388,0.273 -0.308,0.458 -0.185,1.08 0.273,1.388 1.46,0.979 2.838,2.113 4.094,3.369 l 7.398,7.398 -7.629,7.629 c -7.385,7.385 -18.513,9.882 -28.352,6.356 -0.52,-0.187 -1.093,0.084 -1.279,0.604 -0.186,0.52 0.084,1.092 0.604,1.279 3.182,1.14 6.49,1.693 9.776,1.693 7.621,0 15.124,-2.977 20.665,-8.518 l 9.043,-9.043 -8.811,-8.812 z" /> <path d="m 30.539,41.774 c -2.153,0 -4.251,-0.598 -6.07,-1.73 -0.467,-0.29 -1.084,-0.148 -1.377,0.321 -0.292,0.469 -0.148,1.085 0.321,1.377 2.135,1.33 4.6,2.032 7.126,2.032 7.444,0 13.5,-6.056 13.5,-13.5 0,-2.685 -0.787,-5.279 -2.275,-7.502 -0.308,-0.459 -0.93,-0.582 -1.387,-0.275 -0.459,0.308 -0.582,0.929 -0.275,1.387 1.267,1.893 1.937,4.102 1.937,6.39 0,6.342 -5.159,11.5 -11.5,11.5 z" /> <path d="m 30.539,18.774 c 2.065,0 4.089,0.553 5.855,1.6 0.474,0.281 1.088,0.125 1.37,-0.351 0.281,-0.475 0.125,-1.088 -0.351,-1.37 -2.074,-1.229 -4.451,-1.879 -6.875,-1.879 -7.444,0 -13.5,6.056 -13.5,13.5 0,2.084 0.462,4.083 1.374,5.941 0.174,0.354 0.529,0.56 0.899,0.56 0.147,0 0.298,-0.033 0.439,-0.102 0.496,-0.244 0.701,-0.843 0.458,-1.338 -0.776,-1.582 -1.17,-3.284 -1.17,-5.06 0.001,-6.342 5.16,-11.501 11.501,-11.501 z" /> <path d="m 54.621,5.567 c -0.391,-0.391 -1.023,-0.391 -1.414,0 l -46.5,46.5 c -0.391,0.391 -0.391,1.023 0,1.414 0.195,0.195 0.451,0.293 0.707,0.293 0.256,0 0.512,-0.098 0.707,-0.293 l 46.5,-46.5 c 0.391,-0.39 0.391,-1.023 0,-1.414 z" />
                </g>
            </g>
        </g>
    </svg>;
